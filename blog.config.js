...
const BLOG = {
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'DMD个人博客', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '来恰饭呐？🍚', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://dumengdong.store', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || 'Notion, 网站', // 网站关键词 英文逗号隔开
  ...
  //   ********挂件组件相关********
  // Chatbase
  CHATBASE_ID: process.env.NEXT_PUBLIC_CHATBASE_ID || "https://www.chatbase.co/", // 是否显示chatbase机器人 https://www.chatbase.co/
  // 悬浮挂件
  ...
  TITLE: process.env.NEXT_PUBLIC_TITLE || 'DMD的个人博客', // 站点标题 ，被notion中的页面标题覆盖；此处请勿留空白，否则服务器无法编译
  HOME_BANNER_IMAGE:
